 ...
 * 描述:底部弹框
 */
abstract class BaseBottomSheetDialogFragment<DB : ViewDataBinding> : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        setStyle(STYLE_NO_TITLE, R.style.CustomBottomSheetDialogTheme)// 统一设置STYLE_NO_TITLE，解决低版本弹框顶部有条线
