...
public class ToastUtil {
    ...
    /**
     * 全局控制是否显示Toast @param isShowToast
     */
    ...
    public void cancelToast() {
        if (isShow && mToast != null) mToast.cancel();
    }
    ...
    public static void showShort(CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(InitUtils.getApplication(), message, Toast.LENGTH_SHORT);
            } else {
    ...
    public static void showShort(int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(InitUtils.getApplication(), resId, Toast.LENGTH_SHORT);
            } else {
    ...
    public static void showLong(CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(InitUtils.getApplication(), message, Toast.LENGTH_LONG);
            } else {
                mToast.setText(message);
            }
            mToast.show();
    ...
    public static void showLong(int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(InitUtils.getApplication(), resId, Toast.LENGTH_LONG);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
    ...
    public static void show(CharSequence message, int duration) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(InitUtils.getApplication(), message, duration);
            } else {
                mToast.setText(message);
            }
            mToast.show();
    ...
    public static void show(int resId, int duration) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(InitUtils.getApplication(), resId, duration);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
