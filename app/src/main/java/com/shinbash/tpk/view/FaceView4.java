...
import com.shinbash.tpk.utils.ScreenUtils;

public class FaceView4 extends View implements Runnable {
    ...
    public FaceView4(Context context) {
        this(context, null);
    }

    public FaceView4(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FaceView4(Context context, AttributeSet attrs, int defStyleAttr) {
